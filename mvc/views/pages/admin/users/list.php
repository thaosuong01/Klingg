    ...
    <tbody>
        ...
        ?>
                <tr>
                    ...
                    <td class="h-[50px] leading-[50px] text-center"><a class="text-slate-900 delete hover:scale-125 hover:text-red-600 transition-all duration-300_user" href="<?php echo _WEB_ROOT . '/user/delete_user/' . $user['id'] ?>"><i class="fas hover:scale-125 hover:text-red-600 transition-all duration-300 fa-trash-alt"></i></a></td>
                </tr>
        <?php
            }
        } else {
