        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="w-full">
                    ...
                    <form action="" method="post" class="form-info" data-urlreturn="<?php echo _WEB_ROOT.'/information' ?>" data-redirect="<?php echo _WEB_ROOT.'/shipping' ?>">
                        ...
                        <div class="mb-3">
                            <input type="email" class="form-control pt-[10px] pb-[8px] px-3 email" id="exampleFormControlInput1" placeholder="Email">
                        </div>

                        <div class="address-info pb-4">
                            <h5 class="text-xl pt-3">Shipping address</h5>
                            <div class="pb-sm-3 mt-3">
                                <select class="form-select pt-[10px] pb-[12x] px-3 region" aria-label="Default select example">
                            ...
                            <div class="name-info pb-sm-3">
                                <div class="row">
                                    <div class="col">
                                        <input type="text" class="form-control pt-[10px] pb-[8px] px-3 firstname" placeholder="First name" aria-label="First name">
                                    </div>
                                    <div class="col">
                                        <input type="text" class="form-control pt-[10px] pb-[8px] px-3 lastname" placeholder="Last name" aria-label="Last name">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                                <input type="text" class="form-control pt-[10px] pb-[8px] px-3 address" id="exampleFormControlInput1" placeholder="Address">
                            </div>

                            <div class="name-info pb-sm-3">
                                <div class="row">
                                    <div class="col">
                                        <input type="text" class="form-control pt-[10px] pb-[8px] px-3 city" placeholder="City" aria-label="First name">
                                    </div>
                                    <div class="col">
                                        <input type="text" class="form-control pt-[10px] pb-[8px] px-3 phone" placeholder="Phone number" aria-label="Last name">
                                    </div>
                                </div>
                            </div>
                            <?php
                            ...
                            <div class="step-footer d-flex justify-content-sm-between mt-3 align-items-center">
                                ...
                                <div class="product-wishlist-cart">
                                    <a href="<?php echo _WEB_ROOT . '/shipping' ?>">
                                        <button class="dt-sc-btn text-white bg-[#000] py-[10px] px-4 transition-all duration-300 hover:bg-[#eb6420]" type="submit">
